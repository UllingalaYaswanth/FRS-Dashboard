...
function Sidebar() {
  ...
  const SIDEBAR_LINKS = [
    ...
    { id: 2, path: '/statistics', name: 'Statistics', icon: LuChartBar },
    { id: 3, path: '/department', name: 'Department', icon: LuBuilding },
  ];
  ...
  const handleLogout = () => {
    // Optional: Clear any authentication-related data
